...
if module_choice == "1":
    ...
    folders = ["vpc", "eks"]  # order will be adjusted later based on action
else:
...
# Reverse order for destroy (EKS → VPC)
if action == "destroy" and "vpc" in folders and "eks" in folders:
    folders.reverse()
